...
bfA(d,e,f){var w,v,u=null,t=new B.kT(C.pU,x.c),s=new B.kT(C.h2,x.c)
s=new A.a5H(t,s)
s.JP(d,u,e,u)
w=s.a
v=t.r
...
t.r=A.bzO(s)
return s},
bzK(d,e){switch(e){case"appName":return new A.b1c()
...
case"homePage.limitValidator":return new A.b1d()
...
case"homePage.saveInfo":return new A.b1e()
case"aboutPage.version":return new A.b1p()
case"aboutPage.copyright":return new A.b1A()
...
case"menus.about":return new A.b1C()
case"menus.hide":return new A.b1D()
case"menus.hideOthers":return"\u9690\u85cf\u5176\u5b83"
case"menus.showAll":return"\u663e\u793a\u5168\u90e8"
case"menus.exit":return new A.b1E()
...
case"dialogs.permissions.photos.description":return new A.b1F()
case"dialogs.permissions.storage.title":return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"
case"dialogs.permissions.storage.description":return new A.b1G()
case"dialogs.licenseDialog.licenseDialogTitle":return"\u9690\u79c1\u6761\u6b3e"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.b1H()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.b1f()
case"dialogs.licenseDialog.androidPermissions.0":return new A.b1g()
case"dialogs.licenseDialog.androidPermissions.1":return new A.b1h()
case"dialogs.licenseDialog.androidPermissions.2":return new A.b1i()
case"dialogs.licenseDialog.androidPermissions.3":return new A.b1j()
...
b05:function b05(){},
b_G:function b_G(){},
b01:function b01(d,e){var _=this
_.f=d
_.y=_.x=_.w=$
_.a=e
_.e=_.d=_.c=$},
...
if(v===$){w.guy()
w.z!==$&&B.az()
v=w.z=new A.b03()}return v},
gnU(){var w=this,v=w.Q
if(v===$){w.guy()
w.Q!==$&&B.az()
v=w.Q=new A.b_E()}return v},
gpF(){var w=this,v=w.as
if(v===$){w.guy()
w.as!==$&&B.az()
v=w.as=new A.b_I()}return v},
geK(){var w=this,v=w.at
if(v===$){w.guy()
w.at!==$&&B.az()
v=w.at=new A.b05()}return v},
gdS(d){var w=this,v=w.ax
if(v===$){w.guy()
w.ax!==$&&B.az()
v=w.ax=new A.b_G()}return v},
gdK(){var w,v=this,u=v.ay
if(u===$){w=v.guy()
v.ay!==$&&B.az()
u=v.ay=new A.b01(w,w)}return u},
gQQ(){var w=x.g
return B.a4(["en","English","it","Italian","zh","\u4e2d\u6587"],w,w)},
gtB(){return this.x}}
A.b03.prototype={
gNW(){return"\u8b66\u544a: \u5f00\u53d1\u7248\u672c, \u6bcf\u4e2a\u63d0\u4ea4\u81ea\u52a8\u6784\u5efa"},
gkn(d){return"\u672capp\u4e0d\u4f1a\u4e0a\u4f20\u4efb\u4f55\u56fe\u7247\u5230\u670d\u52a1\u5668, \u6240\u6709\u64cd\u4f5c\u5747\u5728\u672c\u5730\u5b8c\u6210"},
gRW(){return"\u6587\u672c"},
gRX(){return"\u6587\u672c\u4f1a\u4ee5\u6c34\u5370\u6dfb\u52a0\u5230\u56fe\u7247\u4e0a"},
gRY(){return"\u8bf7\u8f93\u5165\u6587\u672c."},
gRV(){return"\u6b64\u8bc1\u4ef6\u4ec5\u7528\u4e8e\u529e\u7406xx\u4e1a\u52a1, \u5176\u4ed6\u7528\u9014\u65e0\u6548"},
gOp(){return"\u989c\u8272"},
gOq(){return"\u8bf7\u9009\u62e9\u989c\u8272."},
gRe(){return"\u4e0d\u900f\u660e\u5ea6"},
gPL(){return"\u5b57\u4f53"},
gPM(){return"\u90e8\u5206\u8bed\u8a00\u4e0d\u652f\u6301\u81ea\u5b9a\u4e49\u5b57\u4f53"},
gPO(){return"\u8bf7\u9009\u62e9\u5b57\u4f53."},
gPN(){return"\u5b57\u4f53\u5927\u5c0f"},
gRU(){return"\u6587\u672c\u95f4\u8ddd"},
gRT(){return"\u6bcf\u884c\u6587\u672c\u4e2d, \u6587\u672c\u4e0e\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gRS(){return"\u884c\u95f4\u8ddd"},
gRR(){return"\u6bcf\u884c\u6587\u672c\u4e0e\u6bcf\u884c\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gRt(){return"\u9884\u89c8"},
gIO(d){return"\u4fdd\u5b58"},
gIR(){return"\u4fdd\u5b58\u6210\u529f"},
gBH(){return"\u4fdd\u5b58\u5931\u8d25"},
IP(d,e){return"\u5df2\u4fdd\u5b58"+e+"\u5f20, \u4fdd\u5b58\u5931\u8d25"+d+"\u5f20"}}
A.b_E.prototype={
Ss(d,e,f){return"\u7248\u672c\u53f7 "+f+"("+e+")"},
OK(d,e){return"\u7248\u6743 \xa9 "+e+" "+d+". \u7248\u6743\u6240\u6709\u3002"},
...
if(v===$){w=this.f
v=this.w=new A.b_X(w,w)}return v},
gln(){var w=this.x
return w===$?this.x=new A.b_Q():w},
gk6(){var w,v=this.y
if(v===$){w=this.f
v=this.y=new A.b00(w,w)}return v}}
A.b_X.prototype={
gwc(){var w=this.e
return w===$?this.e=new A.ain():w},
gtZ(d){var w=this.f
return w===$?this.f=new A.aip():w}}
A.b_Q.prototype={
gQK(){return"\u9690\u79c1\u6761\u6b3e"},
QE(d){return d+"\u975e\u5e38\u91cd\u89c6\u4f60\u7684\u9690\u79c1\u4fdd\u62a4\u548c\u4e2a\u4eba\u4fe1\u606f\u4fdd\u62a4."},
gQI(){return"\u4ee5\u4e0b\u662f\u8be5APP\u6240\u9700\u7684\u6743\u9650\u5217\u8868:"},
gQF(){return"\u5728\u4f7f\u7528APP\u670d\u52a1\u524d, \u8bf7\u8ba4\u771f\u9605\u8bfb "},
gQJ(){return"\u300a\u7528\u6237\u670d\u52a1\u534f\u8bae\u300b"},
gQD(){return"\u548c"},
gQG(){return"\u300a\u9690\u79c1\u653f\u7b56\u300b"},
gQH(){return", \u4f60\u540c\u610f\u5e76\u63a5\u53d7\u5168\u90e8\u6761\u6b3e\u540e\u5f00\u59cb\u4f7f\u7528\u6211\u4eec\u7684\u670d\u52a1."},
gQt(){return[new A.b_V()]},
gNS(){return[new A.b_R(),new A.b_S(),new A.b_T(),new A.b_U()]}}
A.b00.prototype={
gtQ(){return"\u8bbe\u7f6e"},
gQy(d){return"\u8bed\u8a00"},
gtx(){var w=this.d
return w===$?this.d=new A.b0_():w},
gS_(){return"\u5f00\u542f\u540e, \u5c06\u8ddf\u968f\u7cfb\u7edf\u6253\u5f00\u6216\u5173\u95ed\u6df1\u8272\u6a21\u5f0f"}}
A.ain.prototype={
...
w(A.ain.prototype,"gkn",1,0,null,["$1$appName"],["m1"],0,0,0)
w(A.aip.prototype,"gkn",1,0,null,["$1$appName"],["m1"],0,0,0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.a5H,B.fK)
w(A.b03,B.LL)
w(A.b_E,B.LD)
w(A.b_I,B.LF)
...
w(A.b_X,B.LI)
w(A.b_Q,B.LH)
v(B.mz,[A.b_V,A.b_R,A.b_S,A.b_T,A.b_U,A.b1L,A.b1c,A.b1d,A.b1e,A.b1p,A.b1A,A.b1C,A.b1D,A.b1E,A.b1F,A.b1G,A.b1H,A.b1f,A.b1g,A.b1h,A.b1i,A.b1j])
w(A.b00,B.LJ)
w(A.ain,B.B7)
w(A.aip,B.B8)
w(A.b0_,B.LK)})()
B.b7O(b.typeUniverse,JSON.parse('{"a5H":{"fK":[],"jq":["fe","fK"]}}'))
...
(a=>{a["UzGlm0qeqz5USRDS8WfEVktwddw="]=a.current})($__dart_deferred_initializers__);