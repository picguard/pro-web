...
bbv(d,e,f){var w,v,u=x.c,t=new B.kB(C.oQ,u)
u=new A.a3S(t,new B.kB(C.fI,u))
u.IX(d,e,null)
w=u.a
v=t.r
v.toString
...
t.r=A.bvX(u)
return u},
bvU(d,e){switch(e){case"appName":return new A.aXP()
...
case"aboutPage.copyright":return new A.aY1()
...
case"menus.about":return new A.aYb()
case"menus.hide":return new A.aYc()
case"menus.hideOthers":return"\u9690\u85cf\u5176\u5b83"
case"menus.showAll":return"\u663e\u793a\u5168\u90e8"
case"menus.exit":return new A.aYd()
...
case"dialogs.permissions.photos.description":return new A.aYe()
case"dialogs.permissions.storage.title":return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"
case"dialogs.permissions.storage.description":return new A.aYf()
case"dialogs.licenseDialog.licenseDialogTitle":return"\u9690\u79c1\u6761\u6b3e"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.aYg()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.aYh()
case"dialogs.licenseDialog.androidPermissions.0":return new A.aXS()
case"dialogs.licenseDialog.androidPermissions.1":return new A.aXT()
case"dialogs.licenseDialog.androidPermissions.2":return new A.aXU()
case"dialogs.licenseDialog.androidPermissions.3":return new A.aXV()
...
if(v===$){w.gu1()
w.Q!==$&&B.ab()
v=w.Q=new A.aWk()}return v},
gpa(){var w=this,v=w.as
if(v===$){w.gu1()
w.as!==$&&B.ab()
v=w.as=new A.aWo()}return v},
...
if(v===$){w.gu1()
w.ax!==$&&B.ab()
v=w.ax=new A.aWm()}return v},
ge1(){var w,v=this,u=v.ay
if(u===$){w=v.gu1()
v.ay!==$&&B.ab()
u=v.ay=new A.aWI(w,w)}return u},
gPN(){var w=x.g
return B.ag(["en","English","it","Italian","zh","\u4e2d\u6587"],w,w)},
gt5(){return this.x}}
A.aWK.prototype={
gMZ(){return"\u8b66\u544a: \u5f00\u53d1\u7248\u672c, \u6bcf\u4e2a\u63d0\u4ea4\u81ea\u52a8\u6784\u5efa"},
gkb(d){return"\u672capp\u4e0d\u4f1a\u4e0a\u4f20\u4efb\u4f55\u56fe\u7247\u5230\u670d\u52a1\u5668, \u6240\u6709\u64cd\u4f5c\u5747\u5728\u672c\u5730\u5b8c\u6210"},
gQT(){return"\u6587\u672c"},
gQU(){return"\u6587\u672c\u4f1a\u4ee5\u6c34\u5370\u6dfb\u52a0\u5230\u56fe\u7247\u4e0a"},
gQV(){return"\u8bf7\u8f93\u5165\u6587\u672c."},
gQS(){return"\u6b64\u8bc1\u4ef6\u4ec5\u7528\u4e8e\u529e\u7406xx\u4e1a\u52a1, \u5176\u4ed6\u7528\u9014\u65e0\u6548"},
gNw(){return"\u989c\u8272"},
gNx(){return"\u8bf7\u9009\u62e9\u989c\u8272."},
gQ9(){return"\u4e0d\u900f\u660e\u5ea6"},
gOQ(){return"\u5b57\u4f53"},
gOR(){return"\u90e8\u5206\u8bed\u8a00\u4e0d\u652f\u6301\u81ea\u5b9a\u4e49\u5b57\u4f53"},
gOT(){return"\u8bf7\u9009\u62e9\u5b57\u4f53."},
gOS(){return"\u5b57\u4f53\u5927\u5c0f"},
gQR(){return"\u6587\u672c\u95f4\u8ddd"},
gQQ(){return"\u6bcf\u884c\u6587\u672c\u4e2d, \u6587\u672c\u4e0e\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gQN(){return"\u884c\u95f4\u8ddd"},
gQM(){return"\u6bcf\u884c\u6587\u672c\u4e0e\u6bcf\u884c\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gQp(){return"\u9884\u89c8"},
gI2(d){return"\u4fdd\u5b58"},
gI5(){return"\u4fdd\u5b58\u6210\u529f"},
gB2(){return"\u4fdd\u5b58\u5931\u8d25"},
I3(d,e){return"\u5df2\u4fdd\u5b58"+e+"\u5f20, \u4fdd\u5b58\u5931\u8d25"+d+"\u5f20"}}
A.aWk.prototype={
Ro(d,e,f){return"\u7248\u672c\u53f7 "+f+"("+e+")"},
NP(d,e){return"\u7248\u6743 \xa9 "+e+" "+d+". \u7248\u6743\u6240\u6709\u3002"},
gIs(){return"\u7ed9\u56fe\u7247\u6dfb\u52a0\u6c34\u5370, \u9632\u6b62\u88ab\u6076\u610f\u4f7f\u7528."},
gQx(){return"\u9879\u76ee\u7b80\u4ecb"},
gMY(){return"\u5e94\u7528\u8bb8\u53ef\u8bc1"},
gNn(){return"\u53d8\u66f4\u65e5\u5fd7"},
gR_(){return"\u7b2c\u4e09\u65b9\u8bb8\u53ef\u8bc1"}}
...
glj(){var w=this.x
if(w===$){w!==$&&B.ab()
w=this.x=new A.aWw()}return w},
gmt(){var w,v=this.y
if(v===$){w=this.f
v!==$&&B.ab()
v=this.y=new A.aWH(w,w)}return v}}
A.aWD.prototype={
gvO(){var w=this.e
if(w===$){w!==$&&B.ab()
w=this.e=new A.afQ()}return w},
gtv(d){var w=this.f
if(w===$){w!==$&&B.ab()
w=this.f=new A.afS()}return w}}
A.aWw.prototype={
gPI(){return"\u9690\u79c1\u6761\u6b3e"},
PC(d){return d+"\u975e\u5e38\u91cd\u89c6\u4f60\u7684\u9690\u79c1\u4fdd\u62a4\u548c\u4e2a\u4eba\u4fe1\u606f\u4fdd\u62a4."},
gPG(){return"\u4ee5\u4e0b\u662f\u8be5APP\u6240\u9700\u7684\u6743\u9650\u5217\u8868:"},
gPD(){return"\u5728\u4f7f\u7528APP\u670d\u52a1\u524d, \u8bf7\u8ba4\u771f\u9605\u8bfb "},
gPH(){return"\u300a\u7528\u6237\u670d\u52a1\u534f\u8bae\u300b"},
gPB(){return"\u548c"},
gPE(){return"\u300a\u9690\u79c1\u653f\u7b56\u300b"},
gPF(){return", \u4f60\u540c\u610f\u5e76\u63a5\u53d7\u5168\u90e8\u6761\u6b3e\u540e\u5f00\u59cb\u4f7f\u7528\u6211\u4eec\u7684\u670d\u52a1."},
gPq(){return[new A.aWB()]},
gMV(){return[new A.aWx(),new A.aWy(),new A.aWz(),new A.aWA()]}}
A.aWH.prototype={
gIl(){return"\u8bbe\u7f6e"},
gPv(d){return"\u8bed\u8a00"},
gt_(){var w=this.d
if(w===$){w!==$&&B.ab()
w=this.d=new A.aWG()}return w},
gQY(){return"\u5f00\u542f\u540e, \u5c06\u8ddf\u968f\u7cfb\u7edf\u6253\u5f00\u6216\u5173\u95ed\u6df1\u8272\u6a21\u5f0f"}}
A.afQ.prototype={
go7(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u76f8\u518c"},
lZ(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.l(e)+"\u8bbf\u95ee\u60a8\u76f8\u518c\u7684\u6743\u9650."}}
A.afS.prototype={
go7(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"},
lZ(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.l(e)+"\u8bbf\u95ee\u60a8\u5b58\u50a8\u7684\u6743\u9650."}}
A.aWG.prototype={
gPT(){return"\u624b\u52a8\u6a21\u5f0f"},
gIW(){return"\u8ddf\u968f\u7cfb\u7edf"},
gF0(){return"\u6df1\u8272\u6a21\u5f0f"},
...
w(A.afQ.prototype,"gkb",1,0,null,["$1$appName"],["lZ"],0,0,0)
w(A.afS.prototype,"gkb",1,0,null,["$1$appName"],["lZ"],0,0,0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.a3S,B.fD)
w(A.aWK,B.L_)
w(A.aWk,B.KS)
w(A.aWo,B.KU)
...
w(A.aWD,B.KX)
w(A.aWw,B.KW)
v(B.m5,[A.aWB,A.aWx,A.aWy,A.aWz,A.aWA,A.aYj,A.aXP,A.aXQ,A.aXR,A.aY1,A.aYb,A.aYc,A.aYd,A.aYe,A.aYf,A.aYg,A.aYh,A.aXS,A.aXT,A.aXU,A.aXV])
w(A.aWH,B.KY)
w(A.afQ,B.Ao)
w(A.afS,B.Ap)
w(A.aWG,B.KZ)})()
B.b3w(b.typeUniverse,JSON.parse('{"a3S":{"fD":[],"j8":["eZ","fD"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_2",e:"endPart",h:b})})($__dart_deferred_initializers__,"OzDf3qS9oC4vKDgYs3+z5HYg8cU=");