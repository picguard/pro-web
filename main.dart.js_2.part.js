...
bdx(d,e,f){var w,v,u=null,t=new B.kI(C.px,x.c),s=new B.kI(C.fX,x.c)
s=new A.a4S(t,s)
s.J3(d,u,e,u)
w=s.a
v=t.r
...
t.r=A.bxM(s)
return s},
bxI(d,e){switch(e){case"appName":return new A.b_n()
...
case"homePage.limitValidator":return new A.b_o()
...
case"homePage.saveInfo":return new A.b_p()
case"aboutPage.version":return new A.b_A()
case"aboutPage.copyright":return new A.b_L()
...
case"menus.about":return new A.b_N()
case"menus.hide":return new A.b_O()
case"menus.hideOthers":return"\u9690\u85cf\u5176\u5b83"
case"menus.showAll":return"\u663e\u793a\u5168\u90e8"
case"menus.exit":return new A.b_P()
...
case"dialogs.permissions.photos.description":return new A.b_Q()
case"dialogs.permissions.storage.title":return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"
case"dialogs.permissions.storage.description":return new A.b_R()
case"dialogs.licenseDialog.licenseDialogTitle":return"\u9690\u79c1\u6761\u6b3e"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.b_S()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.b_q()
case"dialogs.licenseDialog.androidPermissions.0":return new A.b_r()
case"dialogs.licenseDialog.androidPermissions.1":return new A.b_s()
case"dialogs.licenseDialog.androidPermissions.2":return new A.b_t()
case"dialogs.licenseDialog.androidPermissions.3":return new A.b_u()
...
if(v===$){w.gtX()
w.z!==$&&B.a1()
v=w.z=new A.aZk()}return v},
gnt(){var w=this,v=w.Q
if(v===$){w.gtX()
w.Q!==$&&B.a1()
v=w.Q=new A.aYV()}return v},
gp7(){var w=this,v=w.as
if(v===$){w.gtX()
w.as!==$&&B.a1()
v=w.as=new A.aYZ()}return v},
geF(){var w=this,v=w.at
if(v===$){w.gtX()
w.at!==$&&B.a1()
v=w.at=new A.aZm()}return v},
gdP(d){var w=this,v=w.ax
if(v===$){w.gtX()
w.ax!==$&&B.a1()
v=w.ax=new A.aYX()}return v},
gdI(){var w,v=this,u=v.ay
if(u===$){w=v.gtX()
v.ay!==$&&B.a1()
u=v.ay=new A.aZi(w,w)}return u},
gQ7(){var w=x.g
return B.a3(["en","English","it","Italian","zh","\u4e2d\u6587"],w,w)},
grW(){return this.x}}
A.aZk.prototype={
gN9(){return"\u8b66\u544a: \u5f00\u53d1\u7248\u672c, \u6bcf\u4e2a\u63d0\u4ea4\u81ea\u52a8\u6784\u5efa"},
gkb(d){return"\u672capp\u4e0d\u4f1a\u4e0a\u4f20\u4efb\u4f55\u56fe\u7247\u5230\u670d\u52a1\u5668, \u6240\u6709\u64cd\u4f5c\u5747\u5728\u672c\u5730\u5b8c\u6210"},
gRc(){return"\u6587\u672c"},
gRd(){return"\u6587\u672c\u4f1a\u4ee5\u6c34\u5370\u6dfb\u52a0\u5230\u56fe\u7247\u4e0a"},
gRe(){return"\u8bf7\u8f93\u5165\u6587\u672c."},
gRb(){return"\u6b64\u8bc1\u4ef6\u4ec5\u7528\u4e8e\u529e\u7406xx\u4e1a\u52a1, \u5176\u4ed6\u7528\u9014\u65e0\u6548"},
gNG(){return"\u989c\u8272"},
gNH(){return"\u8bf7\u9009\u62e9\u989c\u8272."},
gQv(){return"\u4e0d\u900f\u660e\u5ea6"},
gP3(){return"\u5b57\u4f53"},
gP4(){return"\u90e8\u5206\u8bed\u8a00\u4e0d\u652f\u6301\u81ea\u5b9a\u4e49\u5b57\u4f53"},
gP6(){return"\u8bf7\u9009\u62e9\u5b57\u4f53."},
gP5(){return"\u5b57\u4f53\u5927\u5c0f"},
gRa(){return"\u6587\u672c\u95f4\u8ddd"},
gR9(){return"\u6bcf\u884c\u6587\u672c\u4e2d, \u6587\u672c\u4e0e\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gR7(){return"\u884c\u95f4\u8ddd"},
gR6(){return"\u6bcf\u884c\u6587\u672c\u4e0e\u6bcf\u884c\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gQL(){return"\u9884\u89c8"},
gI3(d){return"\u4fdd\u5b58"},
gI6(){return"\u4fdd\u5b58\u6210\u529f"},
gBc(){return"\u4fdd\u5b58\u5931\u8d25"},
I4(d,e){return"\u5df2\u4fdd\u5b58"+e+"\u5f20, \u4fdd\u5b58\u5931\u8d25"+d+"\u5f20"}}
A.aYV.prototype={
RL(d,e,f){return"\u7248\u672c\u53f7 "+f+"("+e+")"},
NZ(d,e){return"\u7248\u6743 \xa9 "+e+" "+d+". \u7248\u6743\u6240\u6709\u3002"},
gIx(){return"\u7ed9\u56fe\u7247\u6dfb\u52a0\u6c34\u5370, \u9632\u6b62\u88ab\u6076\u610f\u4f7f\u7528."},
gQT(){return"\u9879\u76ee\u7b80\u4ecb"},
gN8(){return"\u5e94\u7528\u8bb8\u53ef\u8bc1"},
gNv(){return"\u53d8\u66f4\u65e5\u5fd7"},
gRi(){return"\u7b2c\u4e09\u65b9\u8bb8\u53ef\u8bc1"}}
...
if(v===$){w=this.f
v!==$&&B.a1()
v=this.w=new A.aZd(w,w)}return v},
glc(){var w=this.x
if(w===$){w!==$&&B.a1()
w=this.x=new A.aZ6()}return w},
gjR(){var w,v=this.y
if(v===$){w=this.f
v!==$&&B.a1()
v=this.y=new A.aZh(w,w)}return v}}
A.aZd.prototype={
gvE(){var w=this.e
if(w===$){w!==$&&B.a1()
w=this.e=new A.ah1()}return w},
gtl(d){var w=this.f
if(w===$){w!==$&&B.a1()
w=this.f=new A.ah3()}return w}}
A.aZ6.prototype={
gQ2(){return"\u9690\u79c1\u6761\u6b3e"},
PX(d){return d+"\u975e\u5e38\u91cd\u89c6\u4f60\u7684\u9690\u79c1\u4fdd\u62a4\u548c\u4e2a\u4eba\u4fe1\u606f\u4fdd\u62a4."},
gQ0(){return"\u4ee5\u4e0b\u662f\u8be5APP\u6240\u9700\u7684\u6743\u9650\u5217\u8868:"},
gPY(){return"\u5728\u4f7f\u7528APP\u670d\u52a1\u524d, \u8bf7\u8ba4\u771f\u9605\u8bfb "},
gQ1(){return"\u300a\u7528\u6237\u670d\u52a1\u534f\u8bae\u300b"},
gPW(){return"\u548c"},
gPZ(){return"\u300a\u9690\u79c1\u653f\u7b56\u300b"},
gQ_(){return", \u4f60\u540c\u610f\u5e76\u63a5\u53d7\u5168\u90e8\u6761\u6b3e\u540e\u5f00\u59cb\u4f7f\u7528\u6211\u4eec\u7684\u670d\u52a1."},
gPK(){return[new A.aZb()]},
gN5(){return[new A.aZ7(),new A.aZ8(),new A.aZ9(),new A.aZa()]}}
A.aZh.prototype={
gtc(){return"\u8bbe\u7f6e"},
gPR(d){return"\u8bed\u8a00"},
grQ(){var w=this.d
if(w===$){w!==$&&B.a1()
w=this.d=new A.aZg()}return w},
gRg(){return"\u5f00\u542f\u540e, \u5c06\u8ddf\u968f\u7cfb\u7edf\u6253\u5f00\u6216\u5173\u95ed\u6df1\u8272\u6a21\u5f0f"}}
A.ah1.prototype={
...
w(A.ah1.prototype,"gkb",1,0,null,["$1$appName"],["lT"],0,0,0)
w(A.ah3.prototype,"gkb",1,0,null,["$1$appName"],["lT"],0,0,0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.a4S,B.fD)
w(A.aZk,B.Ll)
w(A.aYV,B.Ld)
w(A.aYZ,B.Lf)
...
w(A.aZd,B.Li)
w(A.aZ6,B.Lh)
v(B.mo,[A.aZb,A.aZ7,A.aZ8,A.aZ9,A.aZa,A.b_W,A.b_n,A.b_o,A.b_p,A.b_A,A.b_L,A.b_N,A.b_O,A.b_P,A.b_Q,A.b_R,A.b_S,A.b_q,A.b_r,A.b_s,A.b_t,A.b_u])
w(A.aZh,B.Lj)
w(A.ah1,B.AP)
w(A.ah3,B.AQ)
w(A.aZg,B.Lk)})()
B.b5W(b.typeUniverse,JSON.parse('{"a4S":{"fD":[],"jh":["f5","fD"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_2",e:"endPart",h:b})})($__dart_deferred_initializers__,"ozkLJvBGPc6nLbbNK1gbh6jNcw0=");