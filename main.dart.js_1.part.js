...
big(d,e,f){var w,v,u=null,t=new B.kZ(C.po,x.c),s=new B.kZ(C.fZ,x.c)
s=new A.a6c(t,s)
s.K1(d,u,e,u)
w=s.a
v=t.r
...
t.r=A.bDo(s)
return s},
bDl(d,e){switch(e){case"appName":return new A.b2H()
...
case"homePage.limitValidator":return new A.b2I()
...
case"homePage.saveInfo":return new A.b2J()
case"aboutPage.version":return new A.b2K()
case"aboutPage.copyright":return new A.b2L()
...
case"menus.about":return new A.b2N()
case"menus.hide":return new A.b2O()
case"menus.hideOthers":return"Nascondere gli altri"
case"menus.showAll":return"Mostra tutto"
case"menus.exit":return new A.b2P()
...
case"dialogs.permissions.photos.description":return new A.b2Q()
case"dialogs.permissions.storage.title":return"Consenti l'accesso al tuo archivio"
case"dialogs.permissions.storage.description":return new A.b2R()
case"dialogs.licenseDialog.licenseDialogTitle":return"Termini e Condizioni"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.b2S()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.b2T()
case"dialogs.licenseDialog.androidPermissions.0":return new A.b2U()
case"dialogs.licenseDialog.androidPermissions.1":return new A.b2V()
case"dialogs.licenseDialog.androidPermissions.2":return new A.b2W()
case"dialogs.licenseDialog.androidPermissions.3":return new A.b2Y()
...
A.a6c.prototype={
i(d,e){var w=this.x.wL(e)
return w==null?this.a.wL(e):w},
gun(){var w=this.y
if(w===$){w!==$&&B.ab()
w=this.y=this}return w},
m5(d,e){switch(e.a){case 0:return"PicGuard"
case 1:return"PicGuard Pro"}},
gej(){var w=this,v=w.z
if(v===$){w.gun()
w.z!==$&&B.ab()
v=w.z=new A.b1u()}return v},
gnQ(){var w=this,v=w.Q
if(v===$){w.gun()
w.Q!==$&&B.ab()
v=w.Q=new A.b14()}return v},
gpr(){var w=this,v=w.as
if(v===$){w.gun()
w.as!==$&&B.ab()
v=w.as=new A.b18()}return v},
geS(){var w=this,v=w.at
if(v===$){w.gun()
w.at!==$&&B.ab()
v=w.at=new A.b1w()}return v},
gdX(d){var w=this,v=w.ax
if(v===$){w.gun()
w.ax!==$&&B.ab()
v=w.ax=new A.b16()}return v},
gdJ(){var w,v=this,u=v.ay
if(u===$){w=v.gun()
v.ay!==$&&B.ab()
u=v.ay=new A.b1a(w,w)}return u},
gR4(){var w=x.g
...
gSg(){return"Testo"},
gSh(){return y._},
gSi(){return"Inserisci il testo."},
gSf(){return y.N},
gOF(){return"Colore"},
gOG(){return"Seleziona un colore."},
gRu(){return"Opacit\xe0"},
gQ5(){return"Font"},
gQ6(){return y.b},
gQ8(){return"Seleziona un font."},
gQ7(){return"Dimensione del font"},
gSe(){return"Spaziatura del testo"},
gSd(){return y.f},
gSa(){return"Interlinea"},
gS9(){return"La spaziatura tra ogni riga di testo"},
H9(d,e){return"Supporta fino a "+e+" immagini, puoi anche caricare "+d+" immagini."},
gGv(){return"Supportare solo i formati PNG e JPEG"},
gRL(){return"Anteprima"},
gJ5(d){return"Salva"},
gJ8(){return"Salvataggio riuscito"},
gBM(){return"Impossibile salvare l'immagine(i)"},
J6(d,e){return"Sono state salvate "+e+y.I+d+" l'immagine(i)."}}
A.b14.prototype={
SM(d,e,f){return"Versione "+f+"("+e+")"},
P0(d,e){return"Copyright \xa9 "+e+" "+d+". Tutti i diritti riservati."},
gJw(){return"Le tue foto, la tua firma."},
gRT(){return"Introduzione del progetto"},
gO6(){return"Licenza di applicazione"},
gOw(){return"Changelog"},
gSn(){return"Licenze di terze parti"}}
A.b18.prototype={
gSX(){return"Bianco"},
gJ3(){return"Grigio"},
gOj(){return"Nero"},
gtd(){return"Rosso"},
gRv(){return"Arancione"},
gra(){return"Blu"}}
A.b1w.prototype={
uQ(d){return"Di "+d},
Qv(d){return"Nascondere "+d},
gQw(){return"Nascondere gli altri"},
gJu(){return"Mostra tutto"},
G9(d){return"Esentato "+d},
gAb(){return"Aiuto"},
gu0(){return"Supporto"},
gwr(){return"Accordo utente"},
gwc(){return"Politica sulla riservatezza"}}
A.b16.prototype={
gO2(){return"Accetto"},
gOp(d){return"Annulla"},
gGU(){return"Ignora"},
gIz(){return"Accendi"}}
A.b1a.prototype={
gJd(){return"Seleziona un colore"},
gJe(){return"Seleziona un carattere"},
gn6(d){var w,v=this.w
if(v===$){w=this.f
v!==$&&B.ab()
v=this.w=new A.b1n(w,w)}return v},
glA(){var w=this.x
if(w===$){w!==$&&B.ab()
w=this.x=new A.b1b()}return w},
gk8(){var w,v=this.y
if(v===$){w=this.f
v!==$&&B.ab()
v=this.y=new A.b1p(w,w)}return v}}
A.b1n.prototype={
gwb(){var w=this.e
if(w===$){w!==$&&B.ab()
w=this.e=new A.aiF()}return w},
gtR(d){var w=this.f
if(w===$){w!==$&&B.ab()
w=this.f=new A.aiH()}return w}}
A.b1b.prototype={
gR_(){return"Termini e Condizioni"},
QU(d){return y.d+d+"."},
gQY(){return y.n},
gQV(){return y.e},
gQZ(){return"Contratto d'uso"},
gQT(){return" e "},
gQW(){return"L'accordo sulla privacy"},
gQX(){return y.k},
gQH(){return[new A.b1g()]},
gO3(){return[new A.b1c(),new A.b1d(),new A.b1e(),new A.b1f()]}}
A.b1p.prototype={
gtI(){return"Impostazioni"},
gQN(d){return"Lingue"},
gtl(){var w=this.d
if(w===$){w!==$&&B.ab()
w=this.d=new A.b1q()}return w},
gSl(){return y.c}}
A.aiF.prototype={
goo(d){return"Consenti l'accesso al tuo album"},
mb(d,e){return y.B+B.l(e)+y.S}}
A.aiH.prototype={
goo(d){return"Consenti l'accesso al tuo archivio"},
mb(d,e){return y.g+B.l(e)+y.j}}
A.b1q.prototype={
gRb(){return"Modalit\xe0 manuale"},
gK0(){return"Modalit\xe0 automatica"},
gFQ(){return"Modalit\xe0 scura"},
gR0(){return"Modalit\xe0 chiara"}}
...
w(A.aiF.prototype,"gkp",1,0,null,["$1$appName"],["mb"],0,0,0)
w(A.aiH.prototype,"gkp",1,0,null,["$1$appName"],["mb"],0,0,0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.a6c,B.fT)
w(A.b1u,B.Mz)
w(A.b14,B.Mr)
w(A.b18,B.Mt)
...
w(A.b1n,B.Mw)
w(A.b1b,B.Mv)
v(B.mx,[A.b1g,A.b1c,A.b1d,A.b1e,A.b1f,A.b36,A.b2H,A.b2I,A.b2J,A.b2K,A.b2L,A.b2N,A.b2O,A.b2P,A.b2Q,A.b2R,A.b2S,A.b2T,A.b2U,A.b2V,A.b2W,A.b2Y])
w(A.b1p,B.Mx)
w(A.aiF,B.Bx)
w(A.aiH,B.By)
w(A.b1q,B.My)})()
B.b9L(b.typeUniverse,JSON.parse('{"a6c":{"fT":[],"jt":["fb","fT"]}}'))
...
var x={g:B.ao("i"),c:B.ao("kZ<fb,fT>")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_1",e:"endPart",h:b})})($__dart_deferred_initializers__,"cRKpotflXvErUbJS5rQqaTwmlOs=");