...
bdp(d,e,f){var w,v,u=null,t=new B.kI(C.px,x.c),s=new B.kI(C.fX,x.c)
s=new A.a4P(t,s)
s.J0(d,u,e,u)
w=s.a
v=t.r
...
t.r=A.bxF(s)
return s},
bxB(d,e){switch(e){case"appName":return new A.b_h()
...
case"homePage.limitValidator":return new A.b_i()
...
case"homePage.saveInfo":return new A.b_j()
case"aboutPage.version":return new A.b_u()
case"aboutPage.copyright":return new A.b_F()
...
case"menus.about":return new A.b_H()
case"menus.hide":return new A.b_I()
case"menus.hideOthers":return"\u9690\u85cf\u5176\u5b83"
case"menus.showAll":return"\u663e\u793a\u5168\u90e8"
case"menus.exit":return new A.b_J()
...
case"dialogs.permissions.photos.description":return new A.b_K()
case"dialogs.permissions.storage.title":return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"
case"dialogs.permissions.storage.description":return new A.b_L()
case"dialogs.licenseDialog.licenseDialogTitle":return"\u9690\u79c1\u6761\u6b3e"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.b_M()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.b_k()
case"dialogs.licenseDialog.androidPermissions.0":return new A.b_l()
case"dialogs.licenseDialog.androidPermissions.1":return new A.b_m()
case"dialogs.licenseDialog.androidPermissions.2":return new A.b_n()
case"dialogs.licenseDialog.androidPermissions.3":return new A.b_o()
...
if(v===$){w.gtX()
w.z!==$&&B.a1()
v=w.z=new A.aZe()}return v},
gnt(){var w=this,v=w.Q
if(v===$){w.gtX()
w.Q!==$&&B.a1()
v=w.Q=new A.aYP()}return v},
gp7(){var w=this,v=w.as
if(v===$){w.gtX()
w.as!==$&&B.a1()
v=w.as=new A.aYT()}return v},
geG(){var w=this,v=w.at
if(v===$){w.gtX()
w.at!==$&&B.a1()
v=w.at=new A.aZg()}return v},
gdM(d){var w=this,v=w.ax
if(v===$){w.gtX()
w.ax!==$&&B.a1()
v=w.ax=new A.aYR()}return v},
gdG(){var w,v=this,u=v.ay
if(u===$){w=v.gtX()
v.ay!==$&&B.a1()
u=v.ay=new A.aZc(w,w)}return u},
gQ4(){var w=x.g
return B.a3(["en","English","it","Italian","zh","\u4e2d\u6587"],w,w)},
grV(){return this.x}}
A.aZe.prototype={
gN6(){return"\u8b66\u544a: \u5f00\u53d1\u7248\u672c, \u6bcf\u4e2a\u63d0\u4ea4\u81ea\u52a8\u6784\u5efa"},
gka(d){return"\u672capp\u4e0d\u4f1a\u4e0a\u4f20\u4efb\u4f55\u56fe\u7247\u5230\u670d\u52a1\u5668, \u6240\u6709\u64cd\u4f5c\u5747\u5728\u672c\u5730\u5b8c\u6210"},
gR9(){return"\u6587\u672c"},
gRa(){return"\u6587\u672c\u4f1a\u4ee5\u6c34\u5370\u6dfb\u52a0\u5230\u56fe\u7247\u4e0a"},
gRb(){return"\u8bf7\u8f93\u5165\u6587\u672c."},
gR7(){return"\u6b64\u8bc1\u4ef6\u4ec5\u7528\u4e8e\u529e\u7406xx\u4e1a\u52a1, \u5176\u4ed6\u7528\u9014\u65e0\u6548"},
gND(){return"\u989c\u8272"},
gNE(){return"\u8bf7\u9009\u62e9\u989c\u8272."},
gQs(){return"\u4e0d\u900f\u660e\u5ea6"},
gP0(){return"\u5b57\u4f53"},
...
gP2(){return"\u5b57\u4f53\u5927\u5c0f"},
gR6(){return"\u6587\u672c\u95f4\u8ddd"},
gR5(){return"\u6bcf\u884c\u6587\u672c\u4e2d, \u6587\u672c\u4e0e\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gR4(){return"\u884c\u95f4\u8ddd"},
gR3(){return"\u6bcf\u884c\u6587\u672c\u4e0e\u6bcf\u884c\u6587\u672c\u4e4b\u95f4\u7684\u95f4\u8ddd"},
gQI(){return"\u9884\u89c8"},
gI2(d){return"\u4fdd\u5b58"},
gI5(){return"\u4fdd\u5b58\u6210\u529f"},
gBd(){return"\u4fdd\u5b58\u5931\u8d25"},
...
A.aYP.prototype={
RH(d,e,f){return"\u7248\u672c\u53f7 "+f+"("+e+")"},
NW(d,e){return"\u7248\u6743 \xa9 "+e+" "+d+". \u7248\u6743\u6240\u6709\u3002"},
gIv(){return"\u7ed9\u56fe\u7247\u6dfb\u52a0\u6c34\u5370, \u9632\u6b62\u88ab\u6076\u610f\u4f7f\u7528."},
gQQ(){return"\u9879\u76ee\u7b80\u4ecb"},
gN5(){return"\u5e94\u7528\u8bb8\u53ef\u8bc1"},
gNs(){return"\u53d8\u66f4\u65e5\u5fd7"},
gRf(){return"\u7b2c\u4e09\u65b9\u8bb8\u53ef\u8bc1"}}
...
if(v===$){w=this.f
v!==$&&B.a1()
v=this.w=new A.aZ7(w,w)}return v},
glc(){var w=this.x
if(w===$){w!==$&&B.a1()
...
if(v===$){w=this.f
v!==$&&B.a1()
v=this.y=new A.aZb(w,w)}return v}}
A.aZ7.prototype={
gvF(){var w=this.e
if(w===$){w!==$&&B.a1()
w=this.e=new A.agZ()}return w},
gtk(d){var w=this.f
if(w===$){w!==$&&B.a1()
w=this.f=new A.ah0()}return w}}
A.aZ0.prototype={
gQ_(){return"\u9690\u79c1\u6761\u6b3e"},
PU(d){return d+"\u975e\u5e38\u91cd\u89c6\u4f60\u7684\u9690\u79c1\u4fdd\u62a4\u548c\u4e2a\u4eba\u4fe1\u606f\u4fdd\u62a4."},
gPY(){return"\u4ee5\u4e0b\u662f\u8be5APP\u6240\u9700\u7684\u6743\u9650\u5217\u8868:"},
gPV(){return"\u5728\u4f7f\u7528APP\u670d\u52a1\u524d, \u8bf7\u8ba4\u771f\u9605\u8bfb "},
gPZ(){return"\u300a\u7528\u6237\u670d\u52a1\u534f\u8bae\u300b"},
gPT(){return"\u548c"},
gPW(){return"\u300a\u9690\u79c1\u653f\u7b56\u300b"},
gPX(){return", \u4f60\u540c\u610f\u5e76\u63a5\u53d7\u5168\u90e8\u6761\u6b3e\u540e\u5f00\u59cb\u4f7f\u7528\u6211\u4eec\u7684\u670d\u52a1."},
gPH(){return[new A.aZ5()]},
gN2(){return[new A.aZ1(),new A.aZ2(),new A.aZ3(),new A.aZ4()]}}
A.aZb.prototype={
gtb(){return"\u8bbe\u7f6e"},
gPO(d){return"\u8bed\u8a00"},
grP(){var w=this.d
if(w===$){w!==$&&B.a1()
w=this.d=new A.aZa()}return w},
gRd(){return"\u5f00\u542f\u540e, \u5c06\u8ddf\u968f\u7cfb\u7edf\u6253\u5f00\u6216\u5173\u95ed\u6df1\u8272\u6a21\u5f0f"}}
A.agZ.prototype={
gf6(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u76f8\u518c"},
lT(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.k(e)+"\u8bbf\u95ee\u60a8\u76f8\u518c\u7684\u6743\u9650."}}
A.ah0.prototype={
gf6(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"},
lT(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.k(e)+"\u8bbf\u95ee\u60a8\u5b58\u50a8\u7684\u6743\u9650."}}
A.aZa.prototype={
gQ9(){return"\u624b\u52a8\u6a21\u5f0f"},
gIZ(){return"\u8ddf\u968f\u7cfb\u7edf"},
gF3(){return"\u6df1\u8272\u6a21\u5f0f"},
...
w(A.agZ.prototype,"gka",1,0,null,["$1$appName"],["lT"],0,0,0)
w(A.ah0.prototype,"gka",1,0,null,["$1$appName"],["lT"],0,0,0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.a4P,B.fC)
w(A.aZe,B.Li)
w(A.aYP,B.La)
w(A.aYT,B.Lc)
...
w(A.aZ7,B.Lf)
w(A.aZ0,B.Le)
v(B.mo,[A.aZ5,A.aZ1,A.aZ2,A.aZ3,A.aZ4,A.b_Q,A.b_h,A.b_i,A.b_j,A.b_u,A.b_F,A.b_H,A.b_I,A.b_J,A.b_K,A.b_L,A.b_M,A.b_k,A.b_l,A.b_m,A.b_n,A.b_o])
w(A.aZb,B.Lg)
w(A.agZ,B.AN)
w(A.ah0,B.AO)
w(A.aZa,B.Lh)})()
B.b5O(b.typeUniverse,JSON.parse('{"a4P":{"fC":[],"jh":["f5","fC"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_2",e:"endPart",h:b})})($__dart_deferred_initializers__,"l0qdqZ/1bPGJxVjWecnBsrlM9kw=");