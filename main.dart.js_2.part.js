...
bhk(d,e,f){var w,v,u=null,t=new B.kV(C.pQ,x.c),s=new B.kV(C.h0,x.c)
s=new A.a68(t,s)
s.JB(d,u,e,u)
w=s.a
v=t.r
...
t.r=A.bC4(s)
return s},
bC0(d,e){switch(e){case"appName":return new A.b2I()
...
case"homePage.limitValidator":return new A.b2J()
...
case"homePage.saveInfo":return new A.b2K()
case"aboutPage.version":return new A.b2V()
case"aboutPage.copyright":return new A.b35()
...
case"menus.about":return new A.b37()
case"menus.hide":return new A.b38()
case"menus.hideOthers":return"\u9690\u85cf\u5176\u5b83"
case"menus.showAll":return"\u663e\u793a\u5168\u90e8"
case"menus.exit":return new A.b39()
...
case"dialogs.permissions.photos.description":return new A.b3a()
case"dialogs.permissions.storage.title":return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"
case"dialogs.permissions.storage.description":return new A.b3b()
case"dialogs.licenseDialog.licenseDialogTitle":return"\u9690\u79c1\u6761\u6b3e"
case"dialogs.licenseDialog.licenseDialogContentContent":return new A.b3c()
...
case"dialogs.licenseDialog.iosPermissions.0":return new A.b2L()
case"dialogs.licenseDialog.androidPermissions.0":return new A.b2M()
case"dialogs.licenseDialog.androidPermissions.1":return new A.b2N()
case"dialogs.licenseDialog.androidPermissions.2":return new A.b2O()
case"dialogs.licenseDialog.androidPermissions.3":return new A.b2P()
...
if(v===$){w.gu3()
w.z!==$&&B.a3()
v=w.z=new A.b1F()}return v},
gnw(){var w=this,v=w.Q
if(v===$){w.gu3()
w.Q!==$&&B.a3()
v=w.Q=new A.b1f()}return v},
gpb(){var w=this,v=w.as
if(v===$){w.gu3()
w.as!==$&&B.a3()
v=w.as=new A.b1j()}return v},
geM(){var w=this,v=w.at
if(v===$){w.gu3()
w.at!==$&&B.a3()
v=w.at=new A.b1H()}return v},
gdO(d){var w=this,v=w.ax
if(v===$){w.gu3()
w.ax!==$&&B.a3()
v=w.ax=new A.b1h()}return v},
gdI(){var w,v=this,u=v.ay
if(u===$){w=v.gu3()
v.ay!==$&&B.a3()
u=v.ay=new A.b1D(w,w)}return u},
gQI(){var w=x.g
return B.a4(["en","English","it","Italian","zh","\u4e2d\u6587"],w,w)},
gt0(){return this.x}}
A.b1F.prototype={
gNH(){return"\u8b66\u544a: \u5f00\u53d1\u7248\u672c, \u6bcf\u4e2a\u63d0\u4ea4\u81ea\u52a8\u6784\u5efa"},
gkf(d){return"\u672capp\u4e0d\u4f1a\u4e0a\u4f20\u4efb\u4f55\u56fe\u7247\u5230\u670d\u52a1\u5668, \u6240\u6709\u64cd\u4f5c\u5747\u5728\u672c\u5730\u5b8c\u6210"},
gRR(){return"\u6587\u672c"},
...
GB(d,e){return"\u6700\u591a\u652f\u6301"+e+"\u5f20\u56fe\u7247\uff0c\u60a8\u8fd8\u53ef\u4ee5\u4e0a\u4f20"+d+"\u5f20\u56fe\u7247."},
gFZ(){return"\u4ec5\u652f\u6301PNG\u548cJPEG\u683c\u5f0f."},
gRo(){return"\u9884\u89c8"},
gIB(d){return"\u4fdd\u5b58"},
gIE(){return"\u4fdd\u5b58\u6210\u529f"},
gBs(){return"\u4fdd\u5b58\u5931\u8d25"},
IC(d,e){return"\u5df2\u4fdd\u5b58"+e+"\u5f20, \u4fdd\u5b58\u5931\u8d25"+d+"\u5f20"}}
A.b1f.prototype={
Sn(d,e,f){return"\u7248\u672c\u53f7 "+f+"("+e+")"},
Ox(d,e){return"\u7248\u6743 \xa9 "+e+" "+d+". \u7248\u6743\u6240\u6709\u3002"},
gJ4(){return"\u7ed9\u56fe\u7247\u6dfb\u52a0\u6c34\u5370, \u9632\u6b62\u88ab\u6076\u610f\u4f7f\u7528."},
gRw(){return"\u9879\u76ee\u7b80\u4ecb"},
gNG(){return"\u5e94\u7528\u8bb8\u53ef\u8bc1"},
gO2(){return"\u53d8\u66f4\u65e5\u5fd7"},
gRX(){return"\u7b2c\u4e09\u65b9\u8bb8\u53ef\u8bc1"}}
...
if(v===$){w=this.f
v!==$&&B.a3()
v=this.w=new A.b1y(w,w)}return v},
gld(){var w=this.x
if(w===$){w!==$&&B.a3()
w=this.x=new A.b1r()}return w},
gjU(){var w,v=this.y
if(v===$){w=this.f
v!==$&&B.a3()
v=this.y=new A.b1C(w,w)}return v}}
A.b1y.prototype={
gvN(){var w=this.e
if(w===$){w!==$&&B.a3()
...
gts(d){var w=this.f
if(w===$){w!==$&&B.a3()
w=this.f=new A.aiu()}return w}}
A.b1r.prototype={
gQD(){return"\u9690\u79c1\u6761\u6b3e"},
Qx(d){return d+"\u975e\u5e38\u91cd\u89c6\u4f60\u7684\u9690\u79c1\u4fdd\u62a4\u548c\u4e2a\u4eba\u4fe1\u606f\u4fdd\u62a4."},
gQB(){return"\u4ee5\u4e0b\u662f\u8be5APP\u6240\u9700\u7684\u6743\u9650\u5217\u8868:"},
gQy(){return"\u5728\u4f7f\u7528APP\u670d\u52a1\u524d, \u8bf7\u8ba4\u771f\u9605\u8bfb "},
gQC(){return"\u300a\u7528\u6237\u670d\u52a1\u534f\u8bae\u300b"},
gQw(){return"\u548c"},
gQz(){return"\u300a\u9690\u79c1\u653f\u7b56\u300b"},
gQA(){return", \u4f60\u540c\u610f\u5e76\u63a5\u53d7\u5168\u90e8\u6761\u6b3e\u540e\u5f00\u59cb\u4f7f\u7528\u6211\u4eec\u7684\u670d\u52a1."},
gQj(){return[new A.b1w()]},
gND(){return[new A.b1s(),new A.b1t(),new A.b1u(),new A.b1v()]}}
A.b1C.prototype={
gti(){return"\u8bbe\u7f6e"},
gQr(d){return"\u8bed\u8a00"},
grV(){var w=this.d
if(w===$){w!==$&&B.a3()
w=this.d=new A.b1B()}return w},
gRV(){return"\u5f00\u542f\u540e, \u5c06\u8ddf\u968f\u7cfb\u7edf\u6253\u5f00\u6216\u5173\u95ed\u6df1\u8272\u6a21\u5f0f"}}
A.ais.prototype={
gfb(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u76f8\u518c"},
lV(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.k(e)+"\u8bbf\u95ee\u60a8\u76f8\u518c\u7684\u6743\u9650."}}
A.aiu.prototype={
gfb(d){return"\u5141\u8bb8\u8bbf\u95ee\u60a8\u7684\u5b58\u50a8"},
lV(d,e){return"\u8bf7\u524d\u5f80\u60a8\u7684\u624b\u673a\u8bbe\u7f6e\uff0c\u6388\u4e88"+B.k(e)+"\u8bbf\u95ee\u60a8\u5b58\u50a8\u7684\u6743\u9650."}}
A.b1B.prototype={
gQN(){return"\u624b\u52a8\u6a21\u5f0f"},
gJz(){return"\u8ddf\u968f\u7cfb\u7edf"},
gFm(){return"\u6df1\u8272\u6a21\u5f0f"},
...
w(A.ais.prototype,"gkf",1,0,null,["$1$appName"],["lV"],0,0,0)
w(A.aiu.prototype,"gkf",1,0,null,["$1$appName"],["lV"],0,0,0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.a68,B.fO)
w(A.b1F,B.Me)
w(A.b1f,B.M6)
w(A.b1j,B.M8)
...
w(A.b1y,B.Mb)
w(A.b1r,B.Ma)
v(B.mC,[A.b1w,A.b1s,A.b1t,A.b1u,A.b1v,A.b3g,A.b2I,A.b2J,A.b2K,A.b2V,A.b35,A.b37,A.b38,A.b39,A.b3a,A.b3b,A.b3c,A.b2L,A.b2M,A.b2N,A.b2O,A.b2P])
w(A.b1C,B.Mc)
w(A.ais,B.BA)
w(A.aiu,B.BB)
w(A.b1B,B.Md)})()
B.b9v(b.typeUniverse,JSON.parse('{"a68":{"fO":[],"jr":["ff","fO"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_2",e:"endPart",h:b})})($__dart_deferred_initializers__,"aLX+RPzqgAipySDOBUtMYCCkQMo=");